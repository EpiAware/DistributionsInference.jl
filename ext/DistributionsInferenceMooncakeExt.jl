...
# Forward mode matters as well, since `AutoMooncakeForward` hits the same edge
# case. Generalises CD#99, the sibling fix in CD's own Mooncake extension,
# which used the narrower `@from_rrule` and was widened to match in CD#214.
