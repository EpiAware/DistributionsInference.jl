...
```@meta
EditURL = "https://github.com/EpiAware/DistributionsInference.jl/blob/main/NEWS.md"
```

# Release notes

DistributionsInference.jl follows a hybrid changelog approach:
...
See [GitHub Releases](https://github.com/EpiAware/DistributionsInference.jl/releases) for minor/patch
release information.
