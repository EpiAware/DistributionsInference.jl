...
if @isdefined(JET_REPORT_FILTER)
    result = JET.report_package(DistributionsInference;
        target_modules = (DistributionsInference,))
    ...
    JET.test_package(DistributionsInference; target_modules = (DistributionsInference,))
end
